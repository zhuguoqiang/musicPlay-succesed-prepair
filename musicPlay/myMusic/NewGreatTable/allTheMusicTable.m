...
@implementation allTheMusicTable
@synthesize allMusicName;
@synthesize allMusicPath;
...
- (void)viewDidLoad
{
    ...
    UIBarButtonItem *header1=[[UIBarButtonItem alloc] 
                              initWithTitle:@"全选" style:UIBarButtonItemStylePlain target:self action:@selector(sortMusic)];
...
{
    NSLog(@"%@",[self.allMusicName objectAtIndex:15]);
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    // Configure the cell...
    cell.textLabel.text=[self.allMusicName objectAtIndex:[indexPath row]];
    return cell;
}
