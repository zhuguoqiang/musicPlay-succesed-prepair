...
@property(nonatomic, retain)NSMutableArray *loveMusicName;
@property(nonatomic, retain)NSMutableArray *loveMusicPath;

@property(nonatomic, retain)NSMutableArray *myCollectMusicName;
@property(nonatomic, retain)NSMutableArray *myCollectMusicPath;

@property(nonatomic, retain)NSMutableArray *latePlayMusicName;
@property(nonatomic, retain)NSMutableArray *latePlayMusicPath;
